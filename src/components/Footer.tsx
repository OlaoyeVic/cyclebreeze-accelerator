import footer from "../assets/ezgif.com-optimize.gif";
...
const contacts = [
  ...
  {
    icon: location,
    contact: "16, Adeola Hopewell, Victoria Island, Lagos, Nigeria.",
  },
...
const Footer = () => {
  return (
    <>
      <section
        className="relative bg-[#0D1D3B/50] bg-cover w-full h-full overflow-hidden flex flex-col items-center justify-center text-center p-6 md:p-12 h-[500px] md:h-[400px] lg:h-[500px] xl:h-[600px] 2xl:h-[700px]"
        style={{ backgroundImage: `url(${footer})` }}
      >
        <div>
          <h3 className="font-bold text-[30px] leading-[24px] text-white">
        ...
        <div className="flex flex-col md:flex-row md:justify-between items-center md:gap-16">
          {contacts.map((item, index) => (
            ...
            >
              ...
              <>
                <p className="text-white text-center text-sm font-semibold leading-[21px]">
                  {item.contact}
                </p>
              </>
            </div>
      ...
      <div className="hidden bg-[#0D1D3B] text-white text-center p-4 sm:flex justify-between items-center">
        <div className="flex justify-center items-center gap-4">
          <a
            href="https://www.instagram.com/cyclebreeze_/"
            target="_blank"
        ...
        <div className="flex justify-center items-center gap-4">
          ...
          <a
            href="https://www.youtube.com/@cyclebreeze6780"
            target="_blank"
            rel="noopener noreferrer"
          >
